...
<body>
    <div class="container">
      ...
      <p style="margin-top: 10px; margin-bottom: 10px; font-size: 1.8rem;" id="profile-name" class="profile-name-card"><b>MAIN ADMIN </b></p>
   ...
   if(isset($_POST['login']))
    {
        ...
        $qry="select * from mainadmin where usname='$Uname' && passw='$Password'";

...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
                        <a   href="https://app.powerbi.com/groups/me/reports/4d192f04-939e-4f5c-a3e2-6e0bfc0650d6/ReportSection"><i class="fa fa-dashboard"></i>WORKING STATUS </a>
                    </li>
                       <!--  <li>
                        <a   href="shaikpetrecord.php"><i class="fa fa-dashboard"></i>PROBLEMS </a>
                    </li>
                    <li>

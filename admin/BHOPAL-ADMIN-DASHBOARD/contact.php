                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    include ('db.php');
                                    $fetch_query = "SELECT messagec.id ,messagec.fname,messagec.phone,messagec.email,messagec.message FROM messagec WHERE messagec.location = 1";

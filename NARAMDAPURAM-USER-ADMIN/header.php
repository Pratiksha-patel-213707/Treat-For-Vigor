...
<body>
    ...
    <header>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            ...
                            <div class="logo1">
                                ...
                                <img src="img/head-png.png" alt="" style="width: 100%; height: 100%;">
        ...
        <ul id="navigation">
            ...
            <li><a  href="apoinmentbyadminbyuser.php">APOINMENT FORM</a></li>
          ...
          <li><a href="admin/index.php">MAIN ADMIN</a></li>

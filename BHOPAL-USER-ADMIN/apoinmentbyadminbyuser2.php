...
<br>
      <h4 style="font-weight: bold;  ">Gmail</h4>
      <input name="gmail" type ="gmail" class="form-control" placeholder="Enter Gmail ID " required>
<br>  <h4 style="font-weight: bold; ">Gender</h4>
...

{
    ...
    $caseby = "BY USER";
    $stat = "Not Confirm";
            $newUser="INSERT INTO appoinment( fname, phone,gender,agegroup,category,place,date,caseby,stat,gmail) VALUES ('$_POST[fname]','$_POST[phone]','$_POST[gender]','$_POST[agegroup]','$_POST[category]','$place','$curdate','$caseby','$stat','$_POST[category]')";

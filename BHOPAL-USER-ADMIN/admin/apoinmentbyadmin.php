...
<input name="gmail" type ="mail" class="form-control" placeholder="Enter Gmail" required>
...

{
    ...
    $stat = "Not Confirm";
            ...
            $newUser="INSERT INTO appoinment( fname, phone,gender,agegroup,category,place,date,caseby,stat  , gmail) VALUES ('$_POST[fname]','$_POST[phone]','$_POST[gender]','$_POST[agegroup]','$_POST[category]','$place','$curdate','$caseby','$stat','$_POST[gmail]')";
